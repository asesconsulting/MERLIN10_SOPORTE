...
<WebServiceRequestEntity>
   ...
   <name>Address_NE_AI_RutaKM_duplicated</name>
   <tag></tag>
   <elementGuidId>36b1a548-d6b3-4b35-865a-e2d245bbc0b9</elementGuidId>
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>cpa&lt;/name>&lt;value>C1004AAJ&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>NISE&lt;/name>&lt;value>8&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>longitud&lt;/name>&lt;value>-58.373966&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>latitud&lt;/name>&lt;value>-34.602308&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;nivel5>SAN NICOLAS&lt;/nivel5>')
