      ...
      &lt;soap:phoneNormalize2>
         ...
         &lt;phoneNormalize>
            ...
            &lt;xPhone>
               ...
               &lt;!--Optional:-->
               &lt;phoneNumber>01144420390&lt;/phoneNumber>
               &lt;!--Optional:-->
...
WS.verifyElementText(response, 'phoneNormalize2Response.return.nPhone.characteristic', '4442')
WS.verifyElementText(response, 'phoneNormalize2Response.return.nPhone.phoneNumber', '0390')
WS.verifyElementText(response, 'phoneNormalize2Response.return.nPhone.validated', 'SI')
...
assertThat(response.getResponseText()).contains('&lt;name>telefonoCompleto&lt;/name>&lt;value>01144420390&lt;/value>')
assertThat(response.getResponseText()).contains('&lt;name>directory&lt;/name>&lt;value>SI&lt;/value>')
assertThat(response.getResponseText()).contains('&lt;name>fullCellphoneNumber&lt;/name>&lt;value>01144420390&lt;/value>')
assertThat(response.getResponseText()).contains('&lt;name>fullPhone&lt;/name>&lt;value>01144420390&lt;/value>')</verificationScript>
