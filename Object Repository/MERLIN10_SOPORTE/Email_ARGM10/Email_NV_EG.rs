...
<WebServiceRequestEntity>
   ...
   <name>Email_NV_EG</name>
   <tag></tag>
   <elementGuidId>e548a8e5-e0d8-4835-8261-4f8793392a6f</elementGuidId>
   ...
   &lt;soapenv:Body>
      &lt;soap:emailNormalize>
         ...
         &lt;emailNormalize>
            ...
            &lt;xEmail>
               &lt;!--Optional:-->
               &lt;email>ggomez@trcnet.com.ar&lt;/email>
            &lt;/xEmail>
         &lt;/emailNormalize>
      &lt;/soap:emailNormalize>
   &lt;/soapenv:Body>
...
WS.verifyElementText(response, 'emailNormalizeResponse.return.status', '2019-10-15')
WS.verifyElementText(response, 'emailNormalizeResponse.return.statusReason', 'SM')
WS.verifyElementText(response, 'emailNormalizeResponse.return.nEmail.email', 'ggomez@trcnet.com.ar')
WS.verifyElementText(response, 'emailNormalizeResponse.return.nEmail.type', 'ND')
WS.verifyElementText(response, 'emailNormalizeResponse.return.nEmail.lastDateValidated', '2019-09-05')</verificationScript>
