...
<WebServiceRequestEntity>
   ...
   <name>Telefono_Celular_CO_NoLlame</name>
   <tag></tag>
   <elementGuidId>050deedd-20fc-429e-b46e-ed3f051ffc69</elementGuidId>
   ...
   &lt;soapenv:Body>
      &lt;soap:phoneNormalize>
         ...
         &lt;phone>
            ...
            &lt;!--Optional:-->
            &lt;completeNumber>1169338493&lt;/completeNumber>
            &lt;!--Optional:-->
            &lt;cp> &lt;/cp>
            &lt;!--Optional:-->
            &lt;ddi> &lt;/ddi>
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>TEL_COMPLETO&lt;/name>&lt;value>0111569338493&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>CEL_COMPLETO&lt;/name>&lt;value>1169338493&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>PORTAL&lt;/name>&lt;value>PORTAL&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>telefonoCompleto&lt;/name>&lt;value>0111569338493&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;caracteristica>6933&lt;/caracteristica>')
assertThat(response.getResponseText()).contains('&lt;numero>8493&lt;/numero>')
