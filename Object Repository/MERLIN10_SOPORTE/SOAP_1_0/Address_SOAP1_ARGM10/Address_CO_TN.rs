...
<WebServiceRequestEntity>
   ...
   <name>Address_CO_TN</name>
   <tag></tag>
   <elementGuidId>f5ddb370-1457-4087-8cae-82eeab6f8cf0</elementGuidId>
   ...
   &lt;soapenv:Body>
      &lt;soap:addressNormalize>
         ...
         &lt;address>
            &lt;!--Optional:-->
            &lt;calle>avenida libertador 7270&lt;/calle>
            &lt;!--Optional:-->
            &lt;cp> &lt;/cp>
            &lt;!--Optional:-->
            &lt;depto> &lt;/depto>
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>latitud&lt;/name>&lt;value>-34.546420&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>calleAbreviada&lt;/name>&lt;value>AVDA DEL LIBERTADOR&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>latitudLocalidad&lt;/name>&lt;value>-34.607161&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>NISE&lt;/name>&lt;value>9&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>concepto&lt;/name>&lt;value>&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>cpa&lt;/name>&lt;value>C1429BMS&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>longitud&lt;/name>&lt;value>-58.457995&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>barrioAbreviado&lt;/name>&lt;value>NUÑEZ&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;calle>AVDA DEL LIBERTADOR&lt;/calle>')
assertThat(response.getResponseText()).contains('&lt;numero>7270&lt;/numero>')
...
assertThat(response.getResponseText()).contains('&lt;nivel5>NUÑEZ&lt;/nivel5>')
assertThat(response.getResponseText()).contains('&lt;tramo>&lt;/tramo>')
assertThat(response.getResponseText()).contains('&lt;entreCalle1>JUANA AZURDUY DE PADILLA&lt;/entreCalle1>')
assertThat(response.getResponseText()).contains('&lt;entreCalle2>MANUELA PEDRAZA&lt;/entreCalle2>')
