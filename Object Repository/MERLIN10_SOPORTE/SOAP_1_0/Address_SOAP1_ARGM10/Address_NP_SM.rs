...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>fe2c0c72-7445-478e-a21c-dd7b335b3206</elementGuidId>
   ...
   &lt;soapenv:Body>
      &lt;soap:addressNormalize>
         ...
         &lt;address>
            &lt;!--Optional:-->
            &lt;calle>MZ 5 141 BARRIO NAUTICO&lt;/calle>
            &lt;!--Optional:-->
            &lt;cp>192&lt;/cp>
            &lt;!--Optional:-->
            &lt;depto> &lt;/depto>
...
assertThat(response.getResponseText()).contains('&lt;calle>MZ 5  141 BARRIO NAUTICO&lt;/calle>')
...
assertThat(response.getResponseText()).contains('&lt;cp>192&lt;/cp>')
assertThat(response.getResponseText()).contains('&lt;nivel2>&lt;/nivel2>')
assertThat(response.getResponseText()).contains('&lt;nivel3>&lt;/nivel3>')
assertThat(response.getResponseText()).contains('&lt;nivel4>BERISSO&lt;/nivel4>')
