...
<WebServiceRequestEntity>
   ...
   <name>Telefono_Fijo_CO</name>
   <tag></tag>
   <elementGuidId>5a1b6cfd-68e2-4fb4-bb78-2890362e11fb</elementGuidId>
   ...
   &lt;soapenv:Body>
      &lt;soap:phoneNormalize>
         ...
         &lt;phone>
            ...
            &lt;!--Optional:-->
            &lt;completeNumber>1149233521&lt;/completeNumber>
            &lt;!--Optional:-->
            &lt;cp> &lt;/cp>
            &lt;!--Optional:-->
            &lt;ddi> &lt;/ddi>
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>TEL_COMPLETO&lt;/name>&lt;value>01149233521&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>CEL_COMPLETO&lt;/name>&lt;value>01149233521&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>PORTAL&lt;/name>&lt;value>PORTAL&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>telefonoCompleto&lt;/name>&lt;value>01149233521&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;caracteristica>4923&lt;/caracteristica>')
assertThat(response.getResponseText()).contains('&lt;numero>3521&lt;/numero>')
