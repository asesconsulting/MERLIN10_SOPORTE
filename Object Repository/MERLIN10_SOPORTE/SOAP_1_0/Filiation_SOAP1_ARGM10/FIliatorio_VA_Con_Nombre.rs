...
<WebServiceRequestEntity>
   ...
   <name>FIliatorio_VA_Con_Nombre</name>
   <tag></tag>
   <elementGuidId>3f7379d9-2481-4bee-8712-592cb5c8a289</elementGuidId>
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>distanciaAfip&lt;/name>&lt;value>0.00&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>PORTAL&lt;/name>&lt;value>PORTAL&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;birthDate>12/07/1936&lt;/birthDate>')
...
assertThat(response.getResponseText()).contains('&lt;documentNumber>2783891&lt;/documentNumber>')
assertThat(response.getResponseText()).contains('&lt;documentNumberFlg>VA&lt;/documentNumberFlg>')
assertThat(response.getResponseText()).contains('&lt;documentType>89&lt;/documentType>')
assertThat(response.getResponseText()).contains('&lt;documentTypeFlg>AP&lt;/documentTypeFlg>')
assertThat(response.getResponseText()).contains('&lt;lastName>CORDOBA&lt;/lastName>')
...
assertThat(response.getResponseText()).contains('&lt;name>JUANA RAMONA&lt;/name>')
assertThat(response.getResponseText()).contains('&lt;nameFlg>CO&lt;/nameFlg>')
assertThat(response.getResponseText()).contains('&lt;sex>F&lt;/sex>')
...
assertThat(response.getResponseText()).contains('&lt;tributaryNumber>27027838915&lt;/tributaryNumber>')
