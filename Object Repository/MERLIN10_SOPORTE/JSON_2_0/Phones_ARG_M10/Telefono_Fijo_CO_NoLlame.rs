...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>dc714b1b-fc44-4cd1-9a4e-0be0a46b98a1</elementGuidId>
   ...
   <restUrl>${PhoneJson}?phoneNumber=01144420390&amp;clientAccessCode=aea243aba41084aa098b3a70eeb63ddf</restUrl>
...
WS.verifyElementPropertyValue(response, 'nPhone.characteristic', &quot;4442&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.phoneNumber', &quot;0390&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.validated', &quot;SI&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.additionalData', &quot;&quot;)

assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;fullCellphoneNumber&quot;,&quot;value&quot;:&quot;01144420390&quot;}')
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;telefonoCompleto&quot;,&quot;value&quot;:&quot;01144420390&quot;}')
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;directory&quot;,&quot;value&quot;:&quot;SI&quot;}')
...
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;fullPhone&quot;,&quot;value&quot;:&quot;01144420390&quot;}')</verificationScript>
