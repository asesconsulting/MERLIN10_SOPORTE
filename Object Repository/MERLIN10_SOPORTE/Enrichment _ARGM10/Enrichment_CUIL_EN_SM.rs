...
<WebServiceRequestEntity>
   ...
   <name>Enrichment_CUIL_EN_SM</name>
   <tag></tag>
   <elementGuidId>dd7a2aed-f7d6-4253-b757-7a23dad10063</elementGuidId>
...
WS.verifyElementText(response, 'enrichmentResponse.return.nPersonEnrichment.dataRows.row[0].element[0].index', '0')</verificationScript>
