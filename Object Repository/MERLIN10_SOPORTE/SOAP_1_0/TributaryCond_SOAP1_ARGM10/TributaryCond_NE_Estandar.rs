...
<WebServiceRequestEntity>
   ...
   <name>TributaryCond_NE_Estandar</name>
   <tag></tag>
   <elementGuidId>ddf9f373-7895-434c-9b75-fa0b26f3f340</elementGuidId>
...
WS.verifyElementText(response, 'queryCondtribResponse.return.cuit', '30709013196')
WS.verifyElementText(response, 'queryCondtribResponse.return.cuitInfo', '30709013196')
WS.verifyElementText(response, 'queryCondtribResponse.return.denominacion', 'LARRONDO RUBEN OSCAR Y VAZQUEZ')
...
WS.verifyElementText(response, 'queryCondtribResponse.return.ganancias', 'NI')
WS.verifyElementText(response, 'queryCondtribResponse.return.iva', 'NI')
