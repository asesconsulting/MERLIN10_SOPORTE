...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>e846bb32-7366-45d1-a03c-e89911c1f28d</elementGuidId>
   ...
   <restUrl>${PhoneJson}?phoneNumber=1149233521&amp;level1=&amp;clientAccessCode=aea243aba41084aa098b3a70eeb63ddf</restUrl>
...
WS.verifyElementPropertyValue(response, 'nPhone.characteristic', &quot;4923&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.phoneNumber', &quot;3521&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.validated', &quot;NO&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.additionalData', &quot;&quot;)

assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;fullCellphoneNumber&quot;,&quot;value&quot;:&quot;01149233521&quot;}')
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;telefonoCompleto&quot;,&quot;value&quot;:&quot;01149233521&quot;}')
...
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;fullPhone&quot;,&quot;value&quot;:&quot;01149233521&quot;}')</verificationScript>
