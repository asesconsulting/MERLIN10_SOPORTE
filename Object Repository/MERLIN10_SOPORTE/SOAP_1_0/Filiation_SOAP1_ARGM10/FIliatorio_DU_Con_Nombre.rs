...
<WebServiceRequestEntity>
   ...
   <name>FIliatorio_DU_Con_Nombre</name>
   <tag></tag>
   <elementGuidId>9c19bcfa-8ecb-416b-94fd-6665d102a7bf</elementGuidId>
...
assertThat(response.getResponseText()).contains('&lt;birthDate>12/06/1933&lt;/birthDate>')
...
assertThat(response.getResponseText()).contains('&lt;documentNumber>4111807&lt;/documentNumber>')
assertThat(response.getResponseText()).contains('&lt;documentNumberFlg>VA&lt;/documentNumberFlg>')
assertThat(response.getResponseText()).contains('&lt;documentType>90&lt;/documentType>')
assertThat(response.getResponseText()).contains('&lt;documentTypeFlg>AP&lt;/documentTypeFlg>')
assertThat(response.getResponseText()).contains('&lt;lastName>SANTOS&lt;/lastName>')
...
assertThat(response.getResponseText()).contains('&lt;name>OSCAR NERI&lt;/name>')
...
assertThat(response.getResponseText()).contains('&lt;tributaryNumber>20041118076&lt;/tributaryNumber>')
