...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>9af3ce7c-0732-4cb0-8d47-4e7852772232</elementGuidId>
      ...
      &lt;soap:addressNormalize2>
         ...
         &lt;addressNormalize>
            ...
            &lt;xAddress>
               ...
               &lt;level5>&lt;/level5>
               &lt;!--Optional:-->
               &lt;street>HUMBERTO PRIMO&lt;/street>
               &lt;!--Optional:-->
               &lt;houseNumber>1268&lt;/houseNumber>
               &lt;!--Optional:-->
               &lt;floor>&lt;/floor>
               &lt;!--Optional:-->
               &lt;unit>&lt;/unit>
...
&lt;/soapenv:Envelope></soapBody>
   ...
   <variables>
      ...
      <description></description>
      <id>aa71f255-6877-48fb-b85c-c5af2cc13ed3</id>
      <masked>false</masked>
...
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.level4', 'JUJUY')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.level5', '')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.street', 'HUMBERTO PRIMO')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.houseNumber', '1268')
