...
<WebServiceRequestEntity>
   ...
   <name>Filiation_DU_Mapfre_Despejada</name>
   <tag></tag>
   <elementGuidId>87b65f3d-025b-4032-89b3-9d9356996d92</elementGuidId>
      ...
      &lt;soap:filiationNormalize2>
         ...
         &lt;filiationNormalize>
            ...
            &lt;xFiliation>
               ...
               &lt;!--Optional:-->
               &lt;documentNumber>24726693&lt;/documentNumber>
               &lt;!--Optional:-->
...
WS.verifyElementText(response, 'filiationNormalize2Response.return.nFiliation.documentNumber', '24726693')
...
WS.verifyElementText(response, 'filiationNormalize2Response.return.nFiliation.tributaryNumber', '20247266934')
...
WS.verifyElementText(response, 'filiationNormalize2Response.return.nFiliation.lastName', 'PINO')
WS.verifyElementText(response, 'filiationNormalize2Response.return.nFiliation.lastNameFlg', 'AP')
WS.verifyElementText(response, 'filiationNormalize2Response.return.nFiliation.name', 'PABLO')
WS.verifyElementText(response, 'filiationNormalize2Response.return.nFiliation.nameFlg', 'VA')
...
WS.verifyElementText(response, 'filiationNormalize2Response.return.nFiliation.birthDate', '01/08/1975')
WS.verifyElementText(response, 'filiationNormalize2Response.return.nFiliation.birthDateFlg', 'AP')
assertThat(response.getResponseText()).contains('&lt;name>differenceLevelName&lt;/name>&lt;value>0.56&lt;/value>')
assertThat(response.getResponseText()).contains('&lt;name>literalDistance&lt;/name>&lt;value>50.00&lt;/value>')</verificationScript>
