...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>312614e6-1cb5-4a14-9c11-028d55078fe9</elementGuidId>
   ...
   <restUrl>${PhoneJson}?phoneNumber=1105847852&amp;clientAccessCode=aea243aba41084aa098b3a70eeb63ddf</restUrl>
...
WS.verifyElementPropertyValue(response, 'nPhone.phoneNumber', &quot;1105847852&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.validated', &quot;NO&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.additionalData', &quot;&quot;)

assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;fullCellphoneNumber&quot;,&quot;value&quot;:&quot;1105847852&quot;}')
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;telefonoCompleto&quot;,&quot;value&quot;:&quot;1105847852&quot;}')
...
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;fullPhone&quot;,&quot;value&quot;:&quot;1105847852&quot;}')</verificationScript>
