...
<WebServiceRequestEntity>
   ...
   <tag></tag>
   <elementGuidId>6b6d2514-a876-450a-81a3-e91802c9eb71</elementGuidId>
   ...
   <restUrl>${PhoneJson}?phoneNumber=1161755152&amp;clientAccessCode=aea243aba41084aa098b3a70eeb63ddf</restUrl>
...
WS.verifyElementPropertyValue(response, 'nPhone.characteristic', &quot;6175&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.phoneNumber', &quot;5152&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.validated', &quot;NO&quot;)
WS.verifyElementPropertyValue(response, 'nPhone.additionalData', &quot;&quot;)

assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;fullCellphoneNumber&quot;,&quot;value&quot;:&quot;1161755152&quot;}')
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;telefonoCompleto&quot;,&quot;value&quot;:&quot;0111561755152&quot;}')
...
assertThat(response.getResponseText()).contains('{&quot;name&quot;:&quot;fullPhone&quot;,&quot;value&quot;:&quot;0111561755152&quot;}')</verificationScript>
