...
<WebServiceRequestEntity>
   ...
   <name>Enrichment_OtrasVariables</name>
   <tag></tag>
   <elementGuidId>39375f73-dd3e-4e72-9761-ae4b861781cc</elementGuidId>
...
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>AntiguedadVehiculo&lt;/name>&lt;label>&lt;/label>&lt;value>6-10&lt;/value>&lt;index>20&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>CategorizacionVehiculo&lt;/name>&lt;label>&lt;/label>&lt;value>&lt;/value>&lt;index>21&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>AntiguedadVehiculo&lt;/name>&lt;label>&lt;/label>&lt;value>6-10&lt;/value>&lt;index>22&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>CategorizacionVehiculo&lt;/name>&lt;label>&lt;/label>&lt;value>&lt;/value>&lt;index>23&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>NombreDelFamiliar&lt;/name>&lt;label>&lt;/label>&lt;value>DENIARD JUAN CRUZ&lt;/value>&lt;index>24&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>Vinculo&lt;/name>&lt;label>&lt;/label>&lt;value>HIJO&lt;/value>&lt;index>25&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>NombreDelFamiliar&lt;/name>&lt;label>&lt;/label>&lt;value>DENIARD MATEO&lt;/value>&lt;index>26&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>Vinculo&lt;/name>&lt;label>&lt;/label>&lt;value>HIJO&lt;/value>&lt;index>27&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>NombreDelFamiliar&lt;/name>&lt;label>&lt;/label>&lt;value>&lt;/value>&lt;index>28&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')
assertThat(response.getResponseText()).contains('&lt;element>&lt;name>Vinculo&lt;/name>&lt;label>&lt;/label>&lt;value>&lt;/value>&lt;index>29&lt;/index>&lt;dataType>&lt;/dataType>&lt;/element>')</verificationScript>
