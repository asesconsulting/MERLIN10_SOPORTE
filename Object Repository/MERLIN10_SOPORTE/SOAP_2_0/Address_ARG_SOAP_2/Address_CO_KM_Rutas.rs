...
<WebServiceRequestEntity>
   ...
   <name>Address_CO_KM_Rutas</name>
   <tag></tag>
   <elementGuidId>c3658fe4-669f-4f37-840e-a58b05a25142</elementGuidId>
      ...
      &lt;soap:addressNormalize2>
         ...
         &lt;addressNormalize>
            ...
            &lt;xAddress>
               ...
               &lt;level5>&lt;/level5>
               &lt;!--Optional:-->
               &lt;street>AU PANAMERICANA PILAR KM 39,5 SO&lt;/street>
               &lt;!--Optional:-->
...
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.level4', 'MANUEL ALBERTI')
...
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.street', 'AU PANAMERICANA RAMAL PILAR')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.houseNumber', '39,5')
...
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.latitude', '-34.445370')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.longitude', '-58.759263')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.postalCode', '1667')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.additionalPostalCode', '')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.fromStreetNumber', '38,007')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.toStreetNumber', '43,96')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.additionalData', 'SO')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.betweenStreet1', 'AU PANAMERICANA RAMAL PILAR')
WS.verifyElementText(response, 'addressNormalize2Response.return.nAddress.betweenStreet2', 'CAMPO MUNICIP DE GOLF')
...
assertThat(response.getResponseText()).contains('&lt;name>longitudLocalidad&lt;/name>&lt;value>-58.768846&lt;/value>')
...
assertThat(response.getResponseText()).contains('&lt;name>level4Latitude&lt;/name>&lt;value>-34.454214&lt;/value>')
...
assertThat(response.getResponseText()).contains('&lt;name>level4Longitude&lt;/name>&lt;value>-58.768846&lt;/value>')
...
assertThat(response.getResponseText()).contains('&lt;name>latitudLocalidad&lt;/name>&lt;value>-34.454214&lt;/value>')
