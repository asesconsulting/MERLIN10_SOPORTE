...
<WebServiceRequestEntity>
   ...
   <name>Address_NE_AI_DTV_N4</name>
   <tag></tag>
   <elementGuidId>814b882e-7938-4a94-83b3-4ed0f7d02818</elementGuidId>
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>longitud&lt;/name>&lt;value>-58.495411&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>NISE&lt;/name>&lt;value>7&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>REFERENCIA&lt;/name>&lt;value>&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>level4longitudeDTV&lt;/name>&lt;value>-58.445288&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>latitud&lt;/name>&lt;value>-34.549122&lt;/value>&lt;/customValues>')
assertThat(response.getResponseText()).contains('&lt;customValues>&lt;name>level4latitudeDTV&lt;/name>&lt;value>-34.607161&lt;/value>&lt;/customValues>')
...
assertThat(response.getResponseText()).contains('&lt;calle>GRAL MARIANO ACHA&lt;/calle>')
assertThat(response.getResponseText()).contains('&lt;numero>7500&lt;/numero>')
assertThat(response.getResponseText()).contains('&lt;piso>&lt;/piso>')
assertThat(response.getResponseText()).contains('&lt;depto>&lt;/depto>')
assertThat(response.getResponseText()).contains('&lt;cp>1430&lt;/cp>')
assertThat(response.getResponseText()).contains('&lt;nivel2>CAPITAL FEDERAL&lt;/nivel2>')
assertThat(response.getResponseText()).contains('&lt;nivel3>CAP FED&lt;/nivel3>')
assertThat(response.getResponseText()).contains('&lt;nivel4>CABA&lt;/nivel4>')
assertThat(response.getResponseText()).contains('&lt;nivel5>SAAVEDRA&lt;/nivel5>')
