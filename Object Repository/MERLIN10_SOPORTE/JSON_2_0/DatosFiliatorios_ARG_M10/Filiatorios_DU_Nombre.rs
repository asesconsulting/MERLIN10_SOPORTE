...
<WebServiceRequestEntity>
   ...
   <name>Filiatorios_DU_Nombre</name>
   <tag></tag>
   <elementGuidId>1a96f2d5-8c32-4c93-804a-be15657ab465</elementGuidId>
   ...
   <restUrl>${FiliatoriosJson}?documentNumber=4111807&amp;clientAccessCode=aea243aba41084aa098b3a70eeb63ddf&amp;name=SANTOS%20OSCAR%20NERI</restUrl>
...
WS.verifyElementPropertyValue(response, 'nFiliation.documentType', &quot;90&quot;)
WS.verifyElementPropertyValue(response, 'nFiliation.documentTypeFlg', &quot;AP&quot;)
WS.verifyElementPropertyValue(response, 'nFiliation.documentNumber', &quot;4111807&quot;)
...
WS.verifyElementPropertyValue(response, 'nFiliation.tributaryNumber', &quot;20041118076&quot;)
...
WS.verifyElementPropertyValue(response, 'nFiliation.lastName', &quot;SANTOS&quot;)
WS.verifyElementPropertyValue(response, 'nFiliation.lastNameFlg', &quot;AP&quot;)
WS.verifyElementPropertyValue(response, 'nFiliation.name', &quot;OSCAR NERI&quot;)
...
WS.verifyElementPropertyValue(response, 'nFiliation.birthDate', &quot;12/06/1933&quot;)
